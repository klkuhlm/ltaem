...
15        NN=INT((M*M-Q)/DELTA)+1
  ...
  SUBROUTINE JYNB(N,X,NM,BJ,DJ,BY,DY)
    ...
    real(kind=double),dimension(4),parameter:: A=(/-.7031250000000000D-01,.1121520996093750D+00,&
         &-.5725014209747314D+00,.6074042001273483D+01/)
    real(kind=double),dimension(4),parameter:: B=(/ .7324218750000000D-01,-.2271080017089844D+00,&
         &.1727727502584457D+01,-.2438052969955606D+02/)
    real(kind=double),dimension(4),parameter:: A1=(/.1171875000000000D+00,-.1441955566406250D+00,&
         &.6765925884246826D+00,-.6883914268109947D+01/)
    real(kind=double),dimension(4),parameter:: B1=(/-.1025390625000000D+00,.2775764465332031D+00,&
