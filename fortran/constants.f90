module constants
  ...
  real(kind=DP), parameter :: PI = 4.0_DP*atan(1.0_DP) ! 3.1415926535897931...
  real(kind=DP), parameter :: PIOV2 = 2.0_DP*atan(1.0_DP) ! 1.5707963267948966...

  ! these are both used in YNOT approximation to elliptical circumference
  real(kind=DP), parameter :: LN2 = log(2.0_DP) ! 0.69314718055994529...
  real(kind=DP), parameter :: LNPIOV2 = log(2.0_DP*atan(1.0_DP))  ! 0.45158270528945482...
