...
set label 6 'Theis' at 1E+4,7  rotate by 10
set output 'transient_sources_pres.eps'
unset key
set size 0.75,0.75
##
...
plot 'trans_tau-5_dimless.out' using 1:6  with lines ls 11, \
     ...
     'trans_tau-3_dimless.out' using 1:6  with lines ls 1, \
     'trans_tau-2_dimless.out' using 1:6  with lines ls 3, \
     'trans_tau-1_dimless.out' using 1:6  with lines ls 7, \
...
set label 4 'Theis' at 0.1,4.0 rotate by -15
set size 0.75,0.75
set arrow from 1.0,0.015 to 0.8,0.002 front
set output 'transient_sources_surface_earlyt_pres.eps'
plot 'wave_surface_plot_59_1.0E-4.dat' using 1:3 with lines ls 9, \
     'wave_surface_plot_59_1.0E-3.dat' using 1:3 with lines ls 1, \
     'wave_surface_plot_59_1.0E-2.dat' using 1:3 with lines ls 3, \
     'wave_surface_plot_59_1.0E-1.dat' using 1:3 with lines ls 7, \
