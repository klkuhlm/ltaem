...
for t in  "contour" "hydrographs" ; do
    ...
    LD_LIBRARY_PATH=/usr/local/stow/gcc-trunk/lib64 ./ltaem ./pumping_well_${t}.in \
...
for t in  "dualporosity" "leaky1" "leaky2" "leaky3" "stepwiseQ" "linearQ"; do 
    ...
    LD_LIBRARY_PATH=/usr/local/stow/gcc-trunk/lib64 ./ltaem ./pumping_well_${t}_hydrographs.in \
