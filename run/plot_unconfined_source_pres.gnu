...
set xrange [1.0E-1:1.0E+10]
set yrange [1.0E-1:50]
set label 1 'Theis S_s' at 1.0E+7,23 rotate by 10
set label 2 'Theis S_y' at 5.0E5,0.2 rotate by 75
...
set output 'unconfined_source_pres.eps'
unset key 
