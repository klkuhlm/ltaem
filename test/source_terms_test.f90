...
!!$  end interface
  ...
  integer, parameter :: NUMT = 201, DHM = 100, NTYPES = 6, MINLOGT = -8, MAXLOGT = 18
...
do i=1,NUMT
     ...
     do j=1,np
        ...
        call cbesk(rw*kappa1(j), 1.0_DP, 1, 1, bk(1), nz, ierr)
...
!!$
  ...
  do i=1,NUMT
     write(44,'(10(ES15.7E3,1X))') t(i),(ft(i,k),k=0,NTYPES), theis(i,1), theis(i,2)
  end do
